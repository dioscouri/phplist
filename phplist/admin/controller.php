...
class PhplistController extends JController
{
    ...
    */
    function display($cachable=false)
    {
        ...
        $dispatcher->trigger('onBeforeDisplayAdminComponentPhplist', array() );
        ...
        $dispatcher = JDispatcher::getInstance();
        $dispatcher->trigger('onAfterDisplayAdminComponentPhplist', array() );
    ...
    function release()
    {
        ...
        $redirect = "index.php?option=com_phplist&controller=".$this->get('suffix')."&view=".$this->get('suffix')."&task=view&id=".$model->getId()."&donotcheckout=1";
    ...
    function cancel()
    {
        $link = 'index.php?option=com_phplist&view='.$this->get('suffix');
    ...
    function pagetooltip_switch()
    {
        ...
        $msg->message   = '';
        $view = JRequest::getVar('view');
        $msg->link      = 'index.php?option=com_phplist&view='.$view;
        ...
        $config_title = $constant."_disabled";
            ...
            JTable::addIncludePath( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_phplist'.DS.'tables'.DS );
            unset($table);
     ...
     * Usage: index.php?option=com_phplist&task=doTask&element=pluginname&elementTask=pluginfunction
     *
     ...
     * Usage: index.php?option=com_phplist&task=doTaskAjax&element=pluginname&elementTask=pluginfunction
     *
