...
class PhplistCharts 
{
    ...
    function renderFusionChart($data, $title='A Fusion Chart', $type='Column', $width=550, $height=250)
    {
        ...
        if (!empty($data)) 
        {
            ...
            require_once( JPATH_SITE.DS.'media'.DS.'com_phplist'.DS.'fusioncharts'.DS.'FusionCharts_Gen.php' );
            JHTML::_('script', 'FusionCharts.js', 'media/com_phplist/fusioncharts/');
            ...
            $FC->setSWFPath("../media/com_phplist/fusioncharts/Charts/");
